...
export const REGIONAL_TEAMS_DATABASE: {
  ...
  CBLOL: [
    ...
    { id: 'cblol_leviathan', name: 'INTZ', acronym: 'ITZ', primaryColor: '#ffffff', secondaryColor: '#1a1a1a', popularity: 72, budget: 1400000, description: 'Organização histórica do cenário brasileiro, pentacampeã nacional com o lendário Exército de Intrépidos.' },
  ...
  LCK: [
    ...
    { id: 'lck_geng', name: 'Gen.G', acronym: 'GEN', primaryColor: '#ca8a04', secondaryColor: '#000000', popularity: 96, budget: 3200000, description: 'Mestres do macrogame metódico sul-coreano, imbatíveis in campaigns de pontos corridos com extrema precisão de mapa.' },
    ...
    { id: 'lck_bro', name: 'Hanjin Brion', acronym: 'BRO', primaryColor: '#16a34a', secondaryColor: '#1e293b', popularity: 68, budget: 1400000, description: 'Organização tradicional coreana focada em resiliência cirúrgica sob pressão e jogadas disciplinadas na rota inferior.' },
    { id: 'lck_fox', name: 'BNK FearX', acronym: 'FOX', primaryColor: '#eab308', secondaryColor: '#18181b', popularity: 70, budget: 1500000, description: 'A aliança astuta com drafts agressivos e embates explosivos nas rotas do topo e meio no Summoners Rift.' },
    { id: 'lck_ns', name: 'NS RedForce', acronym: 'NS', primaryColor: '#dc2626', secondaryColor: '#111827', popularity: 72, budget: 1600000, description: 'Guerreiros do eSport coreano movidos por disciplina de ferro, alta sinergia defensiva e extrema paciência tática.' },
    { id: 'lck_drx', name: 'DRX', acronym: 'DRX', primaryColor: '#3b82f6', secondaryColor: '#ffffff', popularity: 76, budget: 1800000, description: 'Representantes da lendária jornada de superação absoluta, ostentando o espírito indomável do dragão azul.' },
    { id: 'lck_ds', name: 'DN Soopers', acronym: 'DNS', primaryColor: '#ca8a04', secondaryColor: '#27272a', popularity: 75, budget: 1550000, description: 'Soberanos da selva territorial coreana, trazendo drafts audaciosos e alta flexibilidade estratégica sob pressão.' }
  ],
  LPL: [
    ...
    { id: 'lpl_edg', name: 'EDward Gaming', acronym: 'EDG', primaryColor: '#111111', secondaryColor: '#ff2a2a', popularity: 86, budget: 2600000, description: 'Superpotência clássica com múltipla taça de dinastia passada, focando em controle disciplinado de mapa.' },
    ...
    { id: 'lpl_tt', name: 'TT Gaming', acronym: 'TT', primaryColor: '#e21d38', secondaryColor: '#111111', popularity: 85, budget: 1950000, description: 'Os guerreiros táticos conhecidos pela estabilidade, paciência e alto poder tático na rota inferior.' },
  ...
  LEC: [
    ...
    { id: 'lec_navi', name: 'Natus Vincere', acronym: 'NAV', primaryColor: '#162b4c', secondaryColor: '#ffffff', popularity: 75, budget: 1700000, description: 'Esquadrão tradicional europeu buscando reestabelecer seu domínio estratégico e resiliência.' },
    ...
    { id: 'lec_sh', name: 'Shifters', acronym: 'SHF', primaryColor: '#ca8a04', secondaryColor: '#111111', popularity: 78, budget: 1800000, description: 'Os leões espanhóis prontos para rugir com muita agressividade nas rotas europeias.' }
  ],
  LCS: [
    ...
    { id: 'lcs_sen', name: 'Sentinels', acronym: 'SEN', primaryColor: '#ef4444', secondaryColor: '#1a1a1a', popularity: 89, budget: 2200000, description: 'A marca de estilo de vida e performance competitiva de Los Angeles, conhecida por rosters explosivos e forte apelo de comunidade.' },
    ...
    { id: 'lcs_lyon', name: 'Lyon', acronym: 'LYN', primaryColor: '#eab308', secondaryColor: '#1e3a8a', popularity: 68, budget: 1500000, description: 'Guerreiros da Baía focados em alta cooperação e drafts inovadores no Summoners Rift.' },
    { id: 'lcs_dsg', name: 'Disguised', acronym: 'DSG', primaryColor: '#166534', secondaryColor: '#020617', popularity: 72, budget: 1600000, description: 'Organização clássica da LCS focada em desenvolver novos prodígios mecânicos.' }
  ],
  LCP: [
    { id: 'lcp_mvk', name: 'MVK Esports', acronym: 'MVK', primaryColor: '#ea580c', secondaryColor: '#020617', popularity: 65, budget: 1300000, description: 'Representantes do Vietnã com mentalidade de pilhagem rápida em Summoners Rift.' },
    { id: 'lcp_tsw', name: 'Team Secret Whales', acronym: 'TSW', primaryColor: '#2563eb', secondaryColor: '#111827', popularity: 72, budget: 1500000, description: 'Baleias assassinas do Pacífico prontas para afundar quaisquer favoritos da liga.' },
    ...
    { id: 'lcp_shg', name: 'SoftBank Hawks', acronym: 'SHG', primaryColor: '#3b82f6', secondaryColor: '#1e1b4b', popularity: 82, budget: 2000000, description: 'Lendas absolutas da Oceania, agora no Pacífico carregando o peso da coroa de reis intrépidos.' },
    ...
    { id: 'lcp_gz', name: 'Ground Zero', acronym: 'GZ', primaryColor: '#4b5563', secondaryColor: '#0f172a', popularity: 68, budget: 1350000, description: 'A base zero agressiva do Pacífico, jogando with forte engajamento ofensivo de atirador hipercarries.' },
    { id: 'lcp_dfm', name: 'DetonatioN FM', acronym: 'DFM', primaryColor: '#2563eb', secondaryColor: '#ffffff', popularity: 74, budget: 1550000, description: 'Lendas da terra do sol nascente, sinônimo de precisão tática oriental de alto nível técnico continuado.' }
  ]
};
