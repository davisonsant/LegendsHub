            ...
            {activeProspect ? (
              <div className={`${s.bgCard} p-6 space-y-5 shadow-sm`}>
                ...
                <div className="flex items-center gap-3 pb-3 border-b border-slate-100 dark:border-slate-800">
                  <div className={`w-12 h-12 rounded-xl overflow-hidden ${isDark ? 'bg-slate-900 border-slate-755' : 'bg-slate-50 border-slate-205'} border shrink-0`}>
                    <img 
                      src={activeProspect.photoUrl || 'https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&q=80&w=100'} 
